...
<html lang="en">
    ...
    <body>
        <nav>
            ...
            <a href="/services"><i class="fa-solid fa-gear"></i>Services</a>
            ...
            <div>The design is <span>inspired by another one</span>, and developed by <br><span>Abdelhafid Rahab</span> © {{Date('Y')}}</div>
        </nav>
        <main>
